...
import { calculateStability } from '@/lib/noesisMetrics/calculateStability'
import { calculateVariability } from '@/lib/noesisMetrics/calculateVariability'
import { calculateDeviation } from '@/lib/noesisMetrics/calculateDeviation'
import { calculateReactivity } from '@/lib/noesisMetrics/calculateReactivity'
...
export const generateConflictZoneLogMessage = (
