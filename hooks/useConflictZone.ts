...
import type { ConflictState } from '@/types/conflictZone'
import { calculateDominance } from '@/lib/conflictZone/calculateDominance'
import { applyPowerShift } from '@/lib/conflictZone/applyPowerShift'
import { generatePowerShift } from '@/lib/conflictZone/generatePowerShift'
import { rebalancePower } from '@/lib/conflictZone/rebalancePower'

export const useConflictZone = () => {
